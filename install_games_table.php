...
// TEMPORARY installer to create and populate the `games` table on Railway.
...
// Split on semicolons so PDO can run each statement
...
try {
    ...
    echo "<h1>✅ games table created and data inserted.</h1>";
